...
class ResNet(nn.Module):
    def __init__(self, num_classes: int, zero_init_residual: bool = False) -> None:
        ...
        self.convd1 = nn.Conv2d(256, 128, kernel_size=7, stride=1, padding=3, bias=False)
        self.convd2 = nn.Conv2d(256, 128, kernel_size=7, stride=2, padding=3, bias=False)
        self.convd3 = nn.Conv2d(256, 128, kernel_size=7, stride=4, padding=3, bias=False)
        self.convd4 = nn.Conv2d(256, 128, kernel_size=7, stride=8, padding=3, bias=False)
